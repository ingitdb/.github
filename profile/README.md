...
## Demo Databases
- [**demo-ingitdb**](https://github.com/ingitdb/demo-ingitdb) - the canonical example inGitDB (_Geo data, ToDo_).
...
- [**ingitdb-go**](https://github.com/ingitdb/ingitdb-cli) - CLI and go packages for inGitDB.
